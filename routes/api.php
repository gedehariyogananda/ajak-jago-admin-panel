...
Route::group(['middleware' => 'api'], function () {
    ...
    Route::post('/insert/jago-dalam-sehari/{webinar}/form', [ApiController::class, 'insertJagoDalamSehari'])->name('insertJagoDalamSehari');
    ...
    Route::get('checked/webinar/{webinar}', [ApiController::class, 'isRegisteredWebinar']);

    // pengecekan regster bootcamp
    Route::get('checked/bootcamp', [ApiController::class, 'isRegisteredBootcamp']);

    Route::get('show/profile', [ApiController::class, 'editProfile']);

    Route::post('update/profile', [ApiController::class, 'editProfileAction']);

    Route::post('update/email', [ApiController::class, 'editEmail']);

    Route::post('update/password', [ApiController::class, 'editPassword']);
