...
<div class="col-lg-12 my-4 order-0">
  ...
  @if($webinar->users->count() >= 1)
  <a href="{{ route('exportWebinar', $webinar) }}">Export Responded</a>
  @endif
  <div class="card">
          ...
          <table class="table">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                ...
                <td>
                  <div class="row row-cols-lg-auto g-3 align-items-center">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                      data-bs-target="#staticBackdrop{{ $wbnr->id }}">
                ...
                <div class="modal fade" id="staticBackdrop{{ $wbnr->id }}" data-bs-backdrop="static"
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <ul class="list-group">
                            ...
                            {{-- <li><a href="{{ route('webinar.download',[$webinar->id,$wbnr->id]) }}">download</a>
                            </li> --}}
                            ...
                            <form action="{{ route('webinar.downloadBukti', [$webinar->id, $wbnr->id]) }}"
                              method="post">
                              @csrf
