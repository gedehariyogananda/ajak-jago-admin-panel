...
use App\Exports\RespondedBootcampExport;
...
class ChampController extends Controller
{
    ...
    // export bootcamp
    public function exportBootcamp(Bootcamp $bootcamp)
    {
        return Excel::download(new RespondedBootcampExport($bootcamp), 'respondedBootcamp.xlsx');
    }
}
